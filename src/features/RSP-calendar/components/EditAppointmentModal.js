...
import { AuthInput } from '../../account/components/AccountStyles';
import 
{ 
  ButtonsSection,
  DiscardButton,
...
export const EditAppointmentModal = ({ appointment, isModalVisible, setModalVisible }) => {
        ...
        <ModalContainer>
            <ModalHeader>
             ...
             <ModalBody>
                ...
                />
                <HelperText type='error' visible={errorCheck && hasTimeErrors(startTime)}>
              ...
              <Spacer size='large'>
                ...
                />
                <HelperText type='error' visible={errorCheck && hasTimeErrors(endTime)}>
                  End Time is invalid!
                </HelperText>
              </Spacer>
              <Spacer size='large'>
            ...
            <Divider backgroundColor='gray'/>
                <ButtonsSection>
                    <DiscardButton onPress={() => {setModalVisible(!isModalVisible)}}>
